...
std::thread* create_thread( const uint64_t tid, ResultT* local_result, double* local_duration, bool* local_ready, std::shared_future< void >* sync_barrier, Function&& magic, benchmark_function func ) {
    cpu_set_t cpuset;
    CPU_ZERO( &cpuset );
    CPU_SET( tid, &cpuset );
